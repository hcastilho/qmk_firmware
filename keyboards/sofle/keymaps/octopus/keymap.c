...
[_QWERTY] = LAYOUT(
  ...
  KC_TAB,   GUI_T(KC_A), ALT_T(KC_S), CTL_T(KC_D), SFT_T(KC_F), KC_G,                          KC_H, SFT_T(KC_J), CTL_T(KC_K), ALT_T(KC_L), GUI_T(KC_SCLN), KC_QUOT,
  KC_LSFT,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B, KC_ENT,       KC_APP, KC_N,    KC_M, KC_COMM,  KC_DOT, KC_SLSH,  KC_RSFT,
                 KC_LGUI, KC_LALT, KC_LCTL, LT(_LOWER, KC_SPC), KC_TAB,   KC_BSPC, LT(_RAISE, KC_ENT), KC_RCTL, KC_RALT, KC_RGUI
),
/*
 * GAMING — plain QWERTY, no home row mods, no tap-hold. Thumbs also plain
 * so games see real Ctrl/Alt/Shift/Space instantly. Toggle from ADJUST.
 */
